...
Inference four, finally, is about the relationship between raw values
across time.
...
unit across time.\label{level_relation}}
\end{figure}
...
units over time. A typical time-varying covariates model constrains the
correlation to be equivalent across time. Here, the relationship is
unconstrained at each time point.\label{relation_tvc}}
\end{figure}
