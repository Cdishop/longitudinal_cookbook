...
discover that -- on average across unit -- affect and performance trends
...
After exploring the average (across units) trend level at a certain time
we then move to its variability. Trend lines have a beginning (or end)
point, how consistent do we expect that point to be across the sample?
Is there variability in affect trend starting level? Are there large
between-unit differences in the expected level of the performance trend
...
variable and level in another. On average across units, do people with a
...
between-unit correlation between, say, OCBs and depletion at time one,
again and times two and three, and then ultimately take the average of
each individual correlation.
...
scientists. What is the between-unit relationship (averaged over time)?
...
into a fundamental set, discussed what they mean, and linked the
inferences to appropriate statistical models. Ultimately, researchers
should now be able to understand the spectrum of between-unit inferences
...
within-unit statement: it assesses how a construct moves through time
...
generalize inferences about inter-individual variability from tests of
