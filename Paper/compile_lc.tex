...
messy. When we discuss dynamics section we then use box and arrow
diagrams because they better convey the ideas in that section.
...
correlations, or they constrain them to be equivalent across time.

Figure \ref{relation_tvc} shows the inference with data. Panel A plots
the familiar affect and performance trajectories for each person. The
...
performance at that moment (granted, it is a small sample size). The
