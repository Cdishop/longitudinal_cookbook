...
\hypersetup{unicode=true,
            pdftitle={Between-Unit Inferences With Longitudinal Data},
...
\def\footnote{\protect\rmarkdownfootnote}
  ...
  \title{Between-Unit Inferences With Longitudinal Data}
...
cannot be used to make within-person statements. In general (but not
always), within-person inferences need to come from unpooled,
subject-specific time-series data structures (Molenaar, 2009).
