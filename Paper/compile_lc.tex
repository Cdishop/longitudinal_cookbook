...
\hypertarget{a-note-on-phrasing.-correlating-trends-statement-a-people-with-a-negative-affect-trend-have-a-positive-performance-trend.-some-use-phrases-like-statement-b-when-affect-decreases-performance-goes-up-and-when-affect-increases-performance-goes-down.-you-could-construe-statements-a-and-b-as-equivalent-but-usually-they-are-not.-when-people-state-b-they-actually-mean-when-affect-decreases-performance-immediately-or-subsequently-goes-up-and-at-a-later-point-in-time-when-the-same-trajectory-of-affect-goes-down-performance-immediately-or-subsequently-goes-up.-these-are-very-different-statements.-correlating-trends-only-gives-you-a.}{%
\subsubsection{\texorpdfstring{A note on phrasing. Correlating trends,
statement (a): \enquote{people with a negative affect trend have a
positive performance trend.} Some use phrases like statement (b),
\enquote{when affect decreases performance goes up; and when affect
increases performance goes down.} You could construe statements (a) and
(b) as equivalent, but usually they are not. When people state (b) they
actually mean \enquote{when affect decreases performance immediately or
subsequently goes up, and at a later point in time when the same
trajectory of affect goes down performance immediately or subsequently
goes up.} These are very different statements. Correlating trends only
gives you
(a).}{A note on phrasing. Correlating trends, statement (a): ``people with a negative affect trend have a positive performance trend.'' Some use phrases like statement (b), ``when affect decreases performance goes up; and when affect increases performance goes down.'' You could construe statements (a) and (b) as equivalent, but usually they are not. When people state (b) they actually mean ``when affect decreases performance immediately or subsequently goes up, and at a later point in time when the same trajectory of affect goes down performance immediately or subsequently goes up.'' These are very different statements. Correlating trends only gives you (a).}}\label{a-note-on-phrasing.-correlating-trends-statement-a-people-with-a-negative-affect-trend-have-a-positive-performance-trend.-some-use-phrases-like-statement-b-when-affect-decreases-performance-goes-up-and-when-affect-increases-performance-goes-down.-you-could-construe-statements-a-and-b-as-equivalent-but-usually-they-are-not.-when-people-state-b-they-actually-mean-when-affect-decreases-performance-immediately-or-subsequently-goes-up-and-at-a-later-point-in-time-when-the-same-trajectory-of-affect-goes-down-performance-immediately-or-subsequently-goes-up.-these-are-very-different-statements.-correlating-trends-only-gives-you-a.}}
