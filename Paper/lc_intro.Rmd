...
## Framework
Level. Trend. Dynamics. These are umbrella research foci, each has its own sub-inferences and models. Each section will basically have two notions: trying to understand the thing itself (one variable). Looking at trend or variability in trend. Then looking at correlates or predictors of the thing: correlates of trend, etc. 
