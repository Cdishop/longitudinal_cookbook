...
## Framework
Level. Trend. Dynamics. These are umbrella research foci, each has its own sub-inferences and models. Each section will have several inferences but they all gather into two basic notions: 1) trying to understand the thing itself and variability about the thing itself across units, and 2) correlates or predictors of the thing. 

Each section will also point to models. But there is nuance. The models have different names, some require stationary, some don't. You need to appreciate that and make sure you are attending to all of its nuance. All we are doing here is pointing you in the direction. 
