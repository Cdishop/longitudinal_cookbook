...
#### Inference 3: There are correlated trends. There is a relationship between two trends.
...
trend_table <- data.frame(
  ...
  Examples = c(linebreak('Burnout decreases over time.\nPerformance increases over time.'),
                 ...
                 linebreak('People with positive health status trends have positive happiness trends.\nPeople with positive performance trends have negative anxiety trends.'),
...
### A note on phrasing. Correlating trends, statement (a): "people with a negative affect trend have a positive performance trend." Some use phrases like statement (b), "when affect decreases performance goes up; and when affect increases performance goes down." You could construe statements (a) and (b) as equivalent, but usually they are not. When people state (b) they actually mean "when affect decreases performance immediately or subsequently goes up, and at a later point in time when the same trajectory of affect goes down performance immediately or subsequently goes up." These are very different statements. Correlating trends only gives you (a). 
