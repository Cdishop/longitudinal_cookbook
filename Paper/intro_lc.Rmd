...
## Literature Examples and Hypotheses

There are many examples in our literature that are interested in relationships over time. When a researcher is interested in making a relationships inference, they propose a hypothesis of the form: $x$ predicts $y$ (given some direction, positive or negative). Using our generic variables, we would propose:
