...
## Introduce framework
#### Relationships, Growth, Change, Dynamics
#### These are umbrella research foci. Each has its own sub-inferences and models. 

## Plan for each umbrella foci
#### An introductory paragraph about the general notion
#### A sub question
#### A sub model with SEM (no results, just the string). We can include full model code in an appendix
#### A sub inference
