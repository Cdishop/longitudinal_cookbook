...
* Orgs are systems, systems unfold over time, there are different inferences and research questions we can explore to gain a better understanding of how organizational phenomena unfold over time.

* Linking inferences to models; don't say best models

* 						◊ Of course, none of these types of inferences/questions perfectly discovers the data generating mechanism. Rather, each asks an interesting and important question about a DV and how it relates to an IV. Only with lots of asking about lots of different patterns of relationships across the variables could we piece together the actual data generating process (hopefully having a good theory to guide the way).
