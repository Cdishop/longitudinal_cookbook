...
@Wang2016 review a variety of dynamic models and, although their paper does not provide readers with specific code, it is an excellent resource to become familiar with potential dynamic models. Xu, DeShon, and Dishop (in press) describe why multi-level models are innapropriate for inferences about dynamics and instead recommend a general panel model described in @bollen_general_2010. Other statistical models that are appropriate for dynamic inferences are discussed in @voelkle2015relating, @molenaar_dynamic_1985; @molenaar_merging_2012, @molenaar_testing_2010, @mcardle_latent_2009, and @eschleman_advancing_2014. 
