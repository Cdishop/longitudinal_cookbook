...
>> **Inference 1:** On average, there is self-similarity in $y$; $y$ relates to itself across time. 
...
Figure \ref{dynamics_figure} depicts lag-one change relationships. Does affect predict subsequent performance change? Do prior counterproductive work behaviors relate to current incivility change? Does metacognition predict subsequent exploratory behavior change? Change relationships are also not restricted to lag-one, these are simply the most common. 
