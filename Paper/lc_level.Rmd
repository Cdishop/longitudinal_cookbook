...
The inference table below provides examples of each level inference. Inference one is about level itself -- a single value that describes one time point or the average time point. Inference two is about variability across units in level. Inference three is about correlating those single level estimates. Inference four, finally, is about correlating levels across time. 
